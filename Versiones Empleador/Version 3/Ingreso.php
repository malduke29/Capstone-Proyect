...
<html lang="en">
  ...
  <body>
    ...
    <form class="form-signin" action="ingresando.php" method="POST">
      <div align="center">
  <img class="mb-4" src="images/logo_uai.png" alt="" width="320" height="133">
</div>

    <div class="form-group">
    	<h1 class="h3 mb-3 font-weight-normal" align="center">Ingreso para Solicitud de Certificados Académicos</h1><br>
...
<!--
<h1 class="h5 mb-4 font-weight-normal" align="center">Si no tiene cuenta, registrece <a href="Registro.php">aquí</a></button>!</h1>
  --> 
