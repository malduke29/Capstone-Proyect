...
<?php
    ...
    $Result = mysqli_query($Conectar, "SELECT * FROM users
                                WHERE email = '".$email."'");
...
?>
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        Correo:
        <br>
        <input type="text" name="Correo" value="<?php echo $usuario['email']; ?>">
        <br>
        <br>
...
<div class="col-md-4">
      ...
      <div class="col-md-4">
        User:
        <br>
        <input type="text" name="User" value="<?php echo $usuario['usuario']; ?>" disabled>
        <br>
        <br>
      ...
      <div class="col-md-4">
        Pass:
        <br>
        <input type="text" name="Pass" value="<?php echo $usuario['password']; ?>" pattern="[A-Za-z0-9]{6,16}" title="Un c�digo de seguridad v�lido consiste en una cadena con 6 a 16 caracteres, cada uno de los cuales es una letra o un d�gito, sin simbolos" required>
        <br>
        <br>
<?php
}
